  ...
  return (
    <div className="grid">
      {stream ? (
        ...
        >
          <div style={{ height: "2rem" }}>
            <h3 style={{ color: '#FFFFFF' }} >{myVdoStatus && name}</h3>
          </div>
      ...
      {callAccepted && !callEnded && userVideo && (
        <div className="card2" style={{ textAlign: "center", textTransform: 'uppercase', }} id="video2">
          <div style={{ height: "2rem", textTransform: 'uppercase', }}>
